// eslint-disable-next-line no-proto, no-func-assign
 ...
 */var
	...
	DexSearch = (function () {
		...
		function DexSearch() {
			...
			.setType = function setType(searchType) {
				var _this$typedSearch2; var format = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ''; var speciesOrSet = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
...
this.filters; _i2 < _this$filters2.length; _i2++) {
			...
			.illegalLabel = function illegalLabel(id) {
			...
			.getTier = function getTier(species) {
...
BattleSearchIndex[i - 1][0].substr(0, matchLength) !== query.substr(0, matchLength)) {
			...
			.instafilter = function instafilter(searchType, fType, fId) {
	...
	})(); DexSearch.typeTable = {pokemon:1, type:2, tier:3, move:4, item:5, ability:6, egggroup:7, category:8, article:9}; DexSearch.typeName = {pokemon:'Pok&eacute;mon', type:'Type', tier:'Tiers', move:'Moves', item:'Items', ability:'Abilities', egggroup:'Egg group', category:'Category', article:'Article'}; var
	...
	BattleTypedSearch = (function () {
		...
		function BattleTypedSearch(searchType) {
			...
			.getResults = function getResults(filters, sortCol, reverseSort) {
				var _this = this;
				if (sortCol === 'type') {
...
this.baseResults; _i4 < _this$baseResults2.length; _i4++) {
						var _ref = _this$baseResults2[_i4]; var resultType = _ref[0]; var value = _ref[1];
...
this.baseResults; _i6 < _this$baseResults4.length; _i6++) {
...
this.baseIllegalResults; _i8 < _this$baseIllegalResu2.length; _i8++) {
...
gen;
	...
	BattlePokemonSearch = (function (_BattleTypedSearch) {
		_inheritsLoose(BattlePokemonSearch, _BattleTypedSearch); function BattlePokemonSearch() {
			var _this2; for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}_this2 = _BattleTypedSearch.call.apply(_BattleTypedSearch, [this].concat(args)) || this; _this2
				.sortRow = ['sortpokemon', '']; return _this2;
		} var _proto3 = BattlePokemonSearch.prototype; _proto3
			...
			.getBaseResults = function getBaseResults() {
				var _this$formatType3, _this$formatType4, _this$formatType5, _this$formatType6, _this$formatType7;
...
filters.length; _i10++) {
					var _ref7 = filters[_i10]; var filterType = _ref7[0]; var value = _ref7[1];
					switch (filterType) {
					case 'type':
			...
			.sort = function sort(results, sortCol, reverseSort) {
				...
				if (['hp', 'atk', 'def', 'spa', 'spd', 'spe'].includes(sortCol)) {
					return results.sort(function (_ref8, _ref9) {
						var rowType1 = _ref8[0], id1 = _ref8[1]; var rowType2 = _ref9[0], id2 = _ref9[1];
					...
					return results.sort(function (_ref10, _ref11) {
						var rowType1 = _ref10[0], id1 = _ref10[1]; var rowType2 = _ref11[0], id2 = _ref11[1];
					...
					return results.sort(function (_ref12, _ref13) {
						var rowType1 = _ref12[0], id1 = _ref12[1]; var rowType2 = _ref13[0], id2 = _ref13[1];
						var name1 = id1;
						var name2 = id2;
	...
	})(BattleTypedSearch); var


	BattleAbilitySearch = (function (_BattleTypedSearch2) {
		_inheritsLoose(BattleAbilitySearch, _BattleTypedSearch2); function BattleAbilitySearch() {return _BattleTypedSearch2.apply(this, arguments) || this;} var _proto4 = BattleAbilitySearch.prototype; _proto4
			.getTable = function getTable() {
...
abilities.sort().map(function (abil) {return dex.abilities.get(abil);}); _i12 < _abilities$sort$map2.length; _i12++) {
...
filters.length; _i14++) {
					var _ref14 = filters[_i14]; var filterType = _ref14[0]; var value = _ref14[1];
					switch (filterType) {
					case 'pokemon':
	...
	BattleItemSearch = (function (_BattleTypedSearch3) {
		_inheritsLoose(BattleItemSearch, _BattleTypedSearch3); function BattleItemSearch() {return _BattleTypedSearch3.apply(this, arguments) || this;} var _proto5 = BattleItemSearch.prototype; _proto5
			.getTable = function getTable() {
				return BattleItems;
			}; _proto5
			.getDefaultResults = function getDefaultResults() {
				var _this$formatType8;
				var table = BattleTeambuilderTable;
...
results.length; _i16++) {
					var _this$dex$items$get$i; var row = results[_i16];
...
filters.length; _i18++) {
					var _ref15 = filters[_i18]; var filterType = _ref15[0]; var value = _ref15[1];
					switch (filterType) {
					case 'pokemon':
						if (!Dex.hasAbility(this.dex.species.get(value), ability.name)) return false;
						break;
	...
	BattleMoveSearch = (function (_BattleTypedSearch4) {
		_inheritsLoose(BattleMoveSearch, _BattleTypedSearch4); function BattleMoveSearch() {
			var _this4; for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {args[_key2] = arguments[_key2];}_this4 = _BattleTypedSearch4.call.apply(_BattleTypedSearch4, [this].concat(args)) || this; _this4

				.sortRow = ['sortmove', '']; return _this4;
		} var _proto6 = BattleMoveSearch.prototype; _proto6
			.getTable = function getTable() {
			...
			.moveIsNotUseless = function moveIsNotUseless(id, species, moves, set) {
...
dex.gen > 5 && !moves.includes('aurorabeam') && !moves.includes('glaciate');
			...
			.getBaseResults = function getBaseResults() {
				var _this$formatType9, _this$formatType10, _this$formatType11;
				if (!this.species) return this.getDefaultResults();
				var dex = this.dex;
				var species = dex.species.get(this.species);
				var format = this.format;
				...
				while (learnsetid) {
					...
					if (learnset) {
						for (var moveid in learnset) {
							var _this$formatType12, _BattleTeambuilderTab, _this$formatType13, _BattleTeambuilderTab2;
...
BattleTeambuilderTable['gen9predlc']) != null && _BattleTeambuilderTab2.nonstandardMoves.includes(moveid)) {
				...
				if (isSTABmons) {
					for (var _id11 in this.getTable()) {
						...
						if (_move2.isZ || _move2.isMax) continue;
...
baseSpecies.otherFormes; _i20 < _baseSpecies$otherFor2.length; _i20++) {
...
moves; _i24 < _moves2.length; _i24++) {
...
filters.length; _i28++) {
					var _ref16 = filters[_i28]; var filterType = _ref16[0]; var value = _ref16[1];
					switch (filterType) {
					case 'type':
...
convergenceMoves.length; _i30++) {
					var _id14 = convergenceMoves[_i30];
					var _isUsable = this.moveIsNotUseless(_id14, species, convergenceMoves, this.set);
					if (isUsable) {
			...
			.sort = function sort(results, sortCol, reverseSort) {
				...
				case 'power':
					...
					return results.sort(function (_ref17, _ref18) {
						var rowType1 = _ref17[0], id1 = _ref17[1]; var rowType2 = _ref18[0], id2 = _ref18[1];
				...
				case 'accuracy':
					return results.sort(function (_ref19, _ref20) {
						var rowType1 = _ref19[0], id1 = _ref19[1]; var rowType2 = _ref20[0], id2 = _ref20[1];
				...
				case 'pp':
					return results.sort(function (_ref21, _ref22) {
						var rowType1 = _ref21[0], id1 = _ref21[1]; var rowType2 = _ref22[0], id2 = _ref22[1];
				...
				case 'name':
					return results.sort(function (_ref23, _ref24) {
						var rowType1 = _ref23[0], id1 = _ref23[1]; var rowType2 = _ref24[0], id2 = _ref24[1];
						var name1 = id1;
						var name2 = id2;
						return (name1 < name2 ? -1 : name1 > name2 ? 1 : 0) * sortOrder;
					});
	...
	BattleTypeSearch = (function (_BattleTypedSearch6) {
		_inheritsLoose(BattleTypeSearch, _BattleTypedSearch6); function BattleTypeSearch() {return _BattleTypedSearch6.apply(this, arguments) || this;} var _proto8 = BattleTypeSearch.prototype; _proto8
			.getTable = function getTable() {
...
function checkCanLearn(move, species, setSources, set) {
