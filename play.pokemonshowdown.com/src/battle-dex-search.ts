...
abstract class BattleTypedSearch<T extends SearchType> {
	...
	protected formatType: 'doubles' | 'bdsp' | 'bdspdoubles' | 'bdspnatdex' | 'letsgo' | 'metronome' | 'natdex' | 'nfe' |
	...
	protected firstLearnsetid(speciesid: ID) {
		...
		if (this.formatType === 'nationaldexconcept') table = table['gen9nationaldexconcept'];
...
class BattleItemSearch extends BattleTypedSearch<'item'> {
	...
	getDefaultResults(): SearchRow[] {
		...
		} else if (this.formatType === 'gen9nationaldexconcept') {
